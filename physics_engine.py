...
class DigitalTwinSimulator:
    def __init__(self):
        ...
        # Mesh parameters (Updated for High Accuracy)
        self.Lx = 8
        self.Ly = 3
        self.dx = 0.01
        self.dy = 0.01
    ...
    def step(self, params):
        ...
        if self.iteration % 2 == 0:
            # We now only need 5 Picard iterations because of the direct sparse solver
        ...
        primary_mask = (~self.p_isCEX) & (self.p_x >= 1.0) & (self.p_x <= 2.0)
